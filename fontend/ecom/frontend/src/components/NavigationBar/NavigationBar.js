    ...
    return (
        <Navbar expand="md" style={{backgroundColor:"#4084EA"}}>
            <Container className='header-ctn'>
                ...
                <Form inline className="align-items-center d-flex input-search-ctn">
                    <FormControl type="text" placeholder="Tìm kiếm sản phẩm" className="mr-sm-2 input-search" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
                    <Button variant="" onClick={handleSearch}>Tìm kiếm</Button>
                </Form>
                <div id="basic-navbar-nav " >
                    <div className="align-items-center d-flex" >
                        ...
                        <NavDropdown title={name} id="basic-nav-dropdown" alignRight className='navbar-user'>
                            <NavDropdown.Item href="/getHistoryOrders">Đơn hàng của tôi</NavDropdown.Item>
                            <NavDropdown.Divider />
