    ...
    return (
        <div style={{backgroundColor: "#ffffff", padding:"10px 20px", borderRadius:"20px"}}>
            ...
            <ul className='p-0 m-0'>
                <li className='select-price bg-primary' onClick={() => handlePriceRangeClick('under_100000')}>Dưới 100.000đ</li>
                <li className='select-price bg-primary' onClick={() => handlePriceRangeClick('100000_to_300000')}>100.000đ đến 300.000đ</li>
                <li className='select-price bg-primary' onClick={() => handlePriceRangeClick('300000_to_500000')}>300.000đ đến 500.000đ</li>
                <li className='select-price bg-primary' onClick={() => handlePriceRangeClick('over_500000')}>Trên 500.000đ</li>
            </ul>
        </div>
    );
}
